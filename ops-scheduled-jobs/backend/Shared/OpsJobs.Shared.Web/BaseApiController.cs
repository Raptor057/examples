...
/// <summary>
/// Base de todos los controllers. Despacha al caso de uso, publica la respuesta (lo que dispara
/// el presenter) y traduce el tipo de respuesta a codigo HTTP. El controller no serializa nada
/// por su cuenta: el cuerpo siempre es el envelope que lleno el presenter.
/// </summary>
[ApiController]
public abstract class BaseApiController(IMediator mediator) : ControllerBase
{
    ...
    protected IActionResult MapResult<TController>(IResponse response, ResultViewModel<TController> viewModel) =>
        response switch
        {
            ...
            // Fallo de negocio esperado: HTTP 200 con isSuccess = false. El cliente nunca asume
            // que 200 significa exito; lee isSuccess.
            _ => Ok(viewModel)
        };
}
